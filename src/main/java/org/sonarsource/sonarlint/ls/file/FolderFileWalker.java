...
public class FolderFileWalker implements ClientFileWalker {
  ...
  public FolderFileWalker(WorkspaceFolderWrapper folder, JavaConfigProvider javaConfig, FileTypeClassifier fileTypeClassifier) {
    this.folder = folder;
