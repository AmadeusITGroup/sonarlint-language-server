...
public class SingleFileWalker implements ClientFileWalker {
  ...
  public SingleFileWalker(URI fileUri, Optional<SonarLintExtendedLanguageClient.GetJavaConfigResponse> javaConfigOpt, FileTypeClassifier fileTypeClassifier) {
